...
#define JPFSV_E_PEER_DIED				MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 4 )
#define JPFSV_E_TRACES_ACTIVE			MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 5 )
#define JPFSV_E_NO_TRACESESSION			MAKE_HRESULT(SEVERITY_ERROR, FACILITY_ITF, 6 )
