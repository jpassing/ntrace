...
// Errors
//
#define NTSTATUS_UFBT_STILL_ACTIVE		 _MAKE_NTSTATUS( 3, 1, 0xFD, 0x1 )
#define NTSTATUS_UFBT_AGENT_NOT_FOUND	 _MAKE_NTSTATUS( 3, 1, 0xFD, 0x2 )
#define NTSTATUS_UFBT_INJECTION_FAILED	 _MAKE_NTSTATUS( 3, 1, 0xFD, 0x3 )
#define NTSTATUS_UFBT_PEER_FAILED		 _MAKE_NTSTATUS( 3, 1, 0xFD, 0x4 )
#define NTSTATUS_UFBT_INVALID_PEER_MSG	 _MAKE_NTSTATUS( 3, 1, 0xFD, 0x5 )
#define NTSTATUS_UFBT_UNEXPECTED_PEER_MSG	 _MAKE_NTSTATUS( 3, 1, 0xFD, 0x6 )
...
/*++
	...
	Parameters:
		Process		- Handle to target process. Must have
