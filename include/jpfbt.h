...
// Errors
//
#define NTSTATUS_FBT_NO_THUNKSTACK		 _MAKE_NTSTATUS( 3, 1, 0xFB, 0x1 )
...
#define NTSTATUS_FBT_AUPTR_IN_USE		 _MAKE_NTSTATUS( 3, 1, 0xFB, 0xC )


#define EXCEPTION_FBT_NO_THUNKSTACK		 NTSTATUS_FBT_NO_THUNKSTACK
#define EXCEPTION_FBT_AUPTR_IN_USE		 NTSTATUS_FBT_AUPTR_IN_USE
